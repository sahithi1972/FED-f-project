...
const Features = () => {
  return (
    <section id="features" className="relative py-20 overflow-hidden bg-gradient-to-b from-white to-white/95 dark:from-background dark:to-background/95">
      {/* Background gradient */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="relative h-full rounded-2xl bg-white dark:bg-black/40 p-6 backdrop-blur-sm border border-gray-100 dark:border-white/10">
                <div className="flex items-center gap-4 mb-4">
                  <div className="p-3 rounded-xl bg-gradient-to-br from-[#34D399]/10 to-[#FFB800]/5 border border-[#34D399]/20">
